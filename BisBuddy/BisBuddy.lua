...
function BisBuddyLO.Cell(col, idx)
	...
	-- bordered card: dark fill lifted off the panel + a 1px edge (the status spine below sits on the left)
	c:SetBackdrop({ bgFile = "Interface\\Buttons\\WHITE8X8", edgeFile = "Interface\\Buttons\\WHITE8X8", edgeSize = 1 })
	c:SetBackdropColor(0.086, 0.086, 0.114, 0.92)
	c:SetBackdropBorderColor(0.17, 0.17, 0.21, 1)
...
function BisBuddyLO.Create()
	...
	-- colour legend in the black space under the left column (8 slots)
	f.colorKey = f:CreateFontString(nil, "OVERLAY", "GameFontDisableSmall")
	f.colorKey:SetPoint("TOPLEFT", f.leftCol, "TOPLEFT", 2, -360); f.colorKey:SetJustifyH("LEFT")
	f.colorKey:SetText("|cffc8443c\226\151\143|r upgrade   |cffe8722c\226\151\143|r own it (up tier)\n"
		.. "|cffe0a422\226\151\143|r in bags   |cff35c94a\226\151\143|r equipped BiS\n"
		.. "|cff8c6b26\226\151\143|r set piece   |cff7a7a86\226\151\143|r no data / covered")
	...
	f.list = CreateFrame("Frame", nil, f); f.list:SetPoint("TOP", 0, -64); f.list:SetWidth(288); f.list:SetHeight(400); f.list:Hide()
	...
	f.weightsPanel:SetPoint("TOP", 0, -64); f.weightsPanel:SetWidth(288); f.weightsPanel:SetHeight(400); f.weightsPanel:Hide()
	...
	f.sourcesPanel:SetPoint("TOP", 0, -64); f.sourcesPanel:SetWidth(288); f.sourcesPanel:SetHeight(400); f.sourcesPanel:Hide()
	...
	f.setsPanel:SetPoint("TOP", 0, -64); f.setsPanel:SetWidth(288); f.setsPanel:SetHeight(400); f.setsPanel:Hide()
